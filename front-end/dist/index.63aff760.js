...
var _image1Jpg = require("./assets/image/image1.jpg");
...
function App() {
  ...
  <h1 class = "${(0, _appModuleScssDefault.default).title}">H\u{1ECD}c l\u{1EAD}p tr\xecnh kh\xf4ng kh\xf3</h1>
  <h2>${(0, _momentDefault.default)().format("DD/MM/YYYY    HH:mm:ss")}</h2>
  <h2>\u{110}\u{103}ng l\xfac : ${(0, _momentDefault.default)(createAt).fromNow()}</h2>
  <button class = "btn btn-primary">\u{110}\u{103}ng k\xed ngay</button>
  <img src="${0, _image1JpgDefault.default}" alt = "h\xecnh \u{1EA3}nh"/>
  <h2>SERVER API : ${"http://localhost:4000"}</h2>
  ${(0, _footerDefault.default)()}</div>
  `;
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./components/footer":"bjsug","./components/header":"aorvA","./assets/app.scss":"eKksk","moment":"jwcsj","moment/locale/vi":"6Orob","bootstrap/dist/css/bootstrap.min.css":"i5LP7","./assets/app.module.scss":"fa0H3","./config.json":"8VeYg","./assets/image/image1.jpg":"cBxFe"}],"gkKU3":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aorvA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../assets/header.css":"bScjN","../assets/header.module.scss":"diptl"}],"bScjN":[function() {},{}],"diptl":[function(require,module,exports) {
...
module.exports = JSON.parse('{"API-KEY":"F8","name":"hello"}');

},{}],"cBxFe":[function(require,module,exports) {
module.exports = require("eb763a55904be1d0").getBundleURL("3gKDs") + "image1.a0a2126d.jpg" + "?" + Date.now();

},{"eb763a55904be1d0":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["6DoTH","adjPd"], "adjPd", "parcelRequire8d29")
