...
function updateKaraoke(currentTime) {
  ...
  for (var i = 0; i < sentences.length; i += 2) {
    ...
    var sentence1EndTime =
      sentence1.words[sentence1.words.length - 1].endTime / 1000;
    var sentence2StartTime = sentence2.words[0].startTime / 1000;
    var sentence2EndTime =
      sentence2.words[sentence2.words.length - 1].endTime / 1000;

    if (currentTime >= sentence1StartTime && currentTime <= sentence2EndTime) {
      line1El.innerText = sentence1.words
        .map(function (word) {
          return word.data;
        })
        .join(" ");
      line2El.innerText = sentence2.words
        .map(function (word) {
          return word.data;
        })
        .join(" ");
...
var lyric = {
  ...
  data: {
    ...
    enabledVideoBG: true,
    streamingUrl:
      "https://mcloud-bf-s7-mv-zmp3.zmdcdn.me/ZXv5MtUc9NA/37e9b00b1accf592acdd/127af9a7175ff801a14e/720/Chung-Ta-Cua-Hien-Tai.mp4?authen=exp=1721132712~acl=/ZXv5MtUc9NA/*~hmac=a98b043b315a32ee75ef5f14c9756035",
    defaultIBGUrls: [
