...
btnHome.addEventListener("click", (e) => {
  ...
  const localUrl = "http://127.0.0.1:5500/homework/Day_/ex01.html";
  const gitUrl =
    "https://hoaithu222.github.io/f8_offline_k8/homework/Day_/ex01.html";
...
const preventAccessWhenLoggedIn = () => {
  ...
  if (authToken) {
    const hostname = window.location.hostname;
    const localUrl = "http://127.0.0.1:5500/homework/Day_/home.html";
    const gitUrl =
      "https://hoaithu222.github.io/f8_offline_k8/homework/Day_/home.html";
    const redirectUrl = hostname === "127.0.0.1" ? localUrl : gitUrl;
    window.location.href = redirectUrl;
  }
};
